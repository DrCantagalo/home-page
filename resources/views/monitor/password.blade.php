...
@section('main')
    <main class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 space-y-6">
            @if (!session('email_recover', false) || !session('recover_code', false))
                <form method="post" action="{{url('/')}}/handler" enctype="multipart/form-data" 
                    class="space-y-4">
                        ...
                        <input type="hidden" name="user-verb" value="check-email">
            ...
            @else
                <form method="post" action="{{url('/')}}/handler" enctype="multipart/form-data" 
                    class="space-y-4">
                        ...
                        <input type="hidden" name="user-verb" value="reset-password">
                        <button type="submit"
